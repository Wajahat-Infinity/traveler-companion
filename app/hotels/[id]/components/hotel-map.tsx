      ...
      mapElement.innerHTML = `
        <div class="flex items-center justify-center h-full bg-muted rounded-md">
          <div class="text-center p-8">
            ...
            <p class="text-muted-foreground mt-2">This is a placeholder for an interactive map.</p>
            <p class="text-muted-foreground">In a production environment, this would be an actual map showing ${location}.</p>
          </div>
        </div>
      `
    }
